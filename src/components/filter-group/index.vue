...
<style>
	...
	.vui-pro-filter-group-header .label { flex:1; display:block; height:36px; padding:0 16px; overflow:hidden; white-space:nowrap; text-overflow:ellipsis; color:#262626; line-height:36px; }
	...
	.vui-pro-filter-group-body .vui-row.collapsed { height:36px; }
	...
	.vui-pro-filter-group-footer { display:flex; padding:8px 0; line-height:36px; }
	.vui-pro-filter-group-footer .btn-more { flex:1; display:block; align-items:center; height:36px; padding:0 16px; }
